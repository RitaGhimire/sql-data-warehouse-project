...
BEGIN TRY
 SET @batch_start_time = GETDATE();
    ...
    BEGIN CATCH
    PRINT '-------------------------------------------------------'
    PRINT 'ERROR OCCURED DURNG LOADING BRONZE LAYER'
    ...
    PRINT '>> Load Duration for entire Bronze Layer ' + CAST(DATEDIFF(second, @batch_start_time, @batch_end_time) AS NVARCHAR) + ' seconds';
    END CATCH
END
